...
fun ProfileView(viewModel: ProfileViewModel) {
    ProfileContent(
        ...
        avatarBase64 = viewModel.profilePic.value,
...
fun ProfileContent(
    ...
    height: Int,
    avatarBase64: String?, // Новое поле для аватарки
            ...
            Row(
                ...
                Box(
                    ...
                    if (avatarBase64 != null && avatarBase64 != "") {
                        val imageBitmap = decodeBase64ToImage(avatarBase64)
                        if (imageBitmap != null) {
